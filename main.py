...
# Continously ARP poison the victims in order to not let them restore the ARP Caches
# nice
settings["duckforce"] = False
...
def start():
    ...
    def arp(VICTIM_MAC, VICTIM_IP, duckforce):
        while True:
            ...
            print("(Re-)poisoned the ARP of the following IPs: " + VICTIM_IP +
                  " and " + SERVER_IP)
            time.sleep(20)
